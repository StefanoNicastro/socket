import socket #Server TCP multithread che accetta connessioni da più client e calcola risultati di operazioni aritmetiche
import json #Per la comunicazione di rete
from threading import Thread # Per gestire le connessioni in parallelo (multithreading) # Per la gestione dei dati in formato JSON
...
#Porta di ascolto
DIM_BUFFER=1024
#Dimensione del buffer per la ricezione dati
